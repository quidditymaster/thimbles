...
class TestSpectrographModel(unittest.TestCase):
    ...
    def setUp(self):
        ...
        inp_mod_flux = FluxParameter(self.spec.wv_sample.wv_soln)
        self.spectrograph_mod = SpectrographModel(self.spec, model_wvs, model_flux_p=inp_mod_flux)
    ...
    def test_fine_norm(self):
        fine_norm_p = self.spectrograph_mod.inputs["fine_norm"][0]
